// tests/palette-and-snippet-contract.test.mjs
//
...
//
// Uso:  node tests/palette-and-snippet-contract.test.mjs
...
check(
  ...
  'chart-palette.js: resolvePaletteKey fallback = contapyme',
);
...
console.log(
  'palette-and-snippet-contract.test.mjs: PASS — default contapyme, sin color-scheme en :root, canvas libre, snippets con contexto reactivo',
);
process.exit(0);

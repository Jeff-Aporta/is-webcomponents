...
//
// Uso:  node tests/css-imports.test.mjs
...
if (!existsSync(dist)) {
  console.log('css-imports.test.mjs: SKIP — dist/cdn no existe (corre `node scripts/build.mjs`)');
  process.exit(0);
}
...
console.log(`css-imports.test.mjs: PASS — ${imports} @import locales del CSS publicado resuelven a un archivo real`);
process.exit(0);

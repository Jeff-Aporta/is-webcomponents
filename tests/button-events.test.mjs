// button-events.test.mjs — los 4 eventos propios de <is-button> existen de verdad.
//
// Nace de un fallo concreto: `is-invalid` estaba documentado en la cabecera de
// button.js, en button.md y en el video del componente, pero NADIE lo emitia —
...
const src = readFileSync(join(root, 'src', 'components', 'actions', 'button.js'), 'utf8');

...
const csJs   = await readFile(join(root, 'components', 'feedback', 'cdn-snippet.js'), 'utf8');
const csCss  = await readFile(join(root, 'components', 'feedback', 'cdn-snippet.css'), 'utf8');
const prev   = await readFile(join(root, 'previews', 'feedback', 'is-cdn-snippet.html'), 'utf8');

...
//
// Uso:  node tests/toast-promise.test.ts
...
console.log(`toast-promise.test.ts: PASS — toaster.promise() con loading/success/error, callbacks string|fn|object, preview completo`);
process.exit(0);

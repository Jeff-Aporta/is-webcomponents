// tests/palette-dropdown.test.mjs
//
...
//
// Uso:  node tests/palette-dropdown.test.mjs
...
console.log(`palette-dropdown.test.mjs: PASS — 3 paletas, 1 seleccionado, slots semanticos, CSS distingue activos`);
process.exit(0);
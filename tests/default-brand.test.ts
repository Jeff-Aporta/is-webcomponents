...
const VARIANT_DEFAULTS = [
  { file: 'src/components/actions/button.ts', expected: 'brand' },
  { file: 'src/components/feedback/tag.ts', expected: 'brand' },
  { file: 'src/components/layout/callout.ts', expected: 'brand' },
  { file: 'src/components/feedback/toast-item.ts', expected: 'brand' },
  { file: 'src/components/data/stat.ts', expected: 'brand' },
];

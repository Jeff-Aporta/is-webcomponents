...
import { inferLanguage, resolveLanguage } from '../src/components/_shared/code-langs.ts';
import { softFormat, softFormatMode } from '../src/components/_shared/code-text.ts';
import { formatCode } from '../src/components/_shared/code-format.ts';

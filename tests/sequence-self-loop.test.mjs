// tests/sequence-self-loop.test.mjs
//
...
import { routeSequenceSelf } from '../src/components/_shared/diagram-astar.js';
...
if (failures.length) {
  console.error('sequence-self-loop.test.mjs: FAIL');
  for (const f of failures) console.error('  -', f);
  process.exit(1);
}

console.log(`sequence-self-loop.test.mjs: PASS — herradura OK (4 segmentos, punta en ${route.arrowTipX},${route.arrowTipY})`);
process.exit(0);
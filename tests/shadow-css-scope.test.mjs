// tests/shadow-css-scope.test.mjs
//
...
//
// Uso:  node tests/shadow-css-scope.test.mjs
...
if (failures.length) {
  console.error(`shadow-css-scope.test.mjs: FAIL — ${failures.length} regla(s) de CSS muerto\n`);
  for (const f of failures) console.error(`  ${f}`);
  process.exit(1);
}

console.log('shadow-css-scope.test.mjs: PASS');

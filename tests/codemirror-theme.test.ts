// tests/codemirror-theme.test.ts
//
...
//
// Uso:  node tests/codemirror-theme.test.ts
...
// La logica del highlighter vive en components/_shared/highlight-code.ts
...
check(/export\s+const\s+reapplyTheme/.test(highlight),
  'highlight-code.ts: debe exportar reapplyTheme');
...
console.log('codemirror-theme.test.ts: PASS — CodeMirror theme reactivo a data-theme, re-pinta en vivo, expone API');
process.exit(0);

...
3. `specs/componentes.md` (índice) ? `LLM.md` de categoría ? MD del módulo.
...
| Índice LLM.md | [LLM.md](https://github.com/Jeff-Aporta/is-webcomponents/blob/main/specs/componentes.md) | [raw](https://raw.githubusercontent.com/Jeff-Aporta/is-webcomponents/main/specs/componentes.md) |
...
Antes de cambiar el repo del kit, leer la raíz [`specs/lessons.md`](https://github.com/Jeff-Aporta/is-webcomponents/blob/main/specs/lessons.md) (catálogo de errores) / DO / DON'T / errores). Guardianes: `node tests/llm-contract.test.ts` y el resto de `tests/*.test.mjs`.

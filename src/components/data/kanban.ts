...
(() => {
  ...
  class IsKanbanColumn extends ElementBase {
    ...
    constructor() {
      ...
      this.#root = shadow.querySelector<HTMLElement>('.column')!;
  ...
  class IsKanbanCard extends ElementBase {
    ...
    constructor() {
      ...
      this.#root = shadow.querySelector<HTMLElement>('.card')!;
      this.#cover = shadow.querySelector<HTMLElement>('.cover')!;
      this.#heading = shadow.querySelector<HTMLElement>('.heading')!;
      this.#meta = shadow.querySelector<HTMLElement>('.meta')!;
      this.#tag = shadow.querySelector<HTMLElement>('.tag')!;

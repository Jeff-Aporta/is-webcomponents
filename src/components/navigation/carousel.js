...
(() => {
  ...
  class IsCarousel extends ElementBase {
    ...
    constructor() {
      ...
      this.#scroller = shadow.querySelector('.viewport');
      this.#track = shadow.querySelector('.track');
      this.#indicators = shadow.querySelector('.indicators');
    ...
    #items() {
      return [...this.querySelectorAll(':scope > is-carousel-item')];
    }
    ...
    #sync() {
      ...
      const base = this.shadowRoot.querySelector('.carousel');
    ...
    #updateIndicators() {
      const btns = this.#indicators.querySelectorAll('button');
      btns.forEach((b, i) => {

 ...
 * @param {string} key
 */
export function getProp(record: object|null|undefined, key: string) {
 ...
 * @param {unknown} value
 */
export function setProp(record: object, key: string, value: unknown) {
 ...
 * @param {object|null|undefined} record
 */
export function cloneRecord(record: object|null|undefined) {
  if (!record) return {};
 ...
 */
export function toGridRow(record: object, primaryKeys: string[] = []) {
  let base;
 ...
 */
export function flattenIspColumns(cols: Record<string, any>|null|undefined, out: Array<object> = []) {
 ...
 */
export function columnsFromController(controller: object|null|undefined) {
...
export function lowerCase(s: string|null|undefined) {
  if (!s) return '';

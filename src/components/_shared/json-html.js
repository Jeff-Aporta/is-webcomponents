 ...
 * @returns {ParentNode}
 */
export function json2html(json, parent) {
 ...
 */
export function html2json(node, opts = {}) {
 ...
 */
export function applyJsonBody(host, json, opts = {}) {
 ...
 */
export function hostToJson(host, opts = {}) {
  if (!host) return null;
...
function parseElementTuple(tuple) {

...
export function normalizeTkHue(raw) {
...
export function tkHueToCss(hue, saturation = 65, lightness = 52) {
...
export function tkHueToHex(hue, saturation = 65, lightness = 52) {
  const h = normalizeTkHue(hue);
  if (h == null) return undefined;
...
export function resolveTkHue(raw, fallback) {

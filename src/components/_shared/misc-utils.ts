 ...
 * @returns {string}
 */
export function tidy(n: number, unit: string = '') {
 ...
 * @returns {number}
 */
export function tidyToStep(n: number, step: number|string) {
 ...
 * @returns {number}
 */
export function clampTo(n: number, min: number, max: number) {
 ...
 * @returns {boolean}
 */
export function isValidNumber(v: unknown) {

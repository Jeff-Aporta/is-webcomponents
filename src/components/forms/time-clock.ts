...
(() => {
  ...
  class IsTimeClock extends ElementBase {
    ...
    constructor() {
      ...
      this.#clock = shadow.querySelector<HTMLElement>('.clock')!;
      this.#hand = shadow.querySelector<HTMLElement>('.hand')!;
      this.#outer = shadow.querySelector<HTMLElement>('.ring.outer')!;
      this.#inner = shadow.querySelector<HTMLElement>('.ring.inner')!;

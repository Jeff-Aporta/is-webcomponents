...
preview: ../../previews/data-viz/is-funnel-chart.html
---
# `<is-funnel-chart>`
...
de gráfica es siempre funnel chart.
...
| `config` | lectura/escritura | Forma Chart.js; `type` se fuerza a `funnel`. |
...
- [JavaScript](./funnel-chart.js)
- [CSS](./funnel-chart.css)

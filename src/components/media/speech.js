...
(() => {
  ...
  class IsSpeech extends HTMLElement {
    static get observedAttributes() { return ['lang', 'text']; }
    ...
    constructor() {
      ...
      this.#out = shadow.querySelector('.out');
      this.#listenBtn = shadow.querySelector('.listen');
      this.#speakBtn = shadow.querySelector('.speak');
    ...
    disconnectedCallback() { this.stop(); this.cancel(); }

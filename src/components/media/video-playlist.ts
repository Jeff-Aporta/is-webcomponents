...
(() => {
  ...
  class IsVideoPlaylist extends withStyleAttrs(HTMLElement) {
    ...
    constructor() {
      ...
      this.#root = shadow.querySelector<HTMLElement>('.video-playlist')!;
      this.#listEl = shadow.querySelector<HTMLElement>('.playlist-items')!;
      this.#slot = shadow.querySelector<HTMLSlotElement>('slot:not([name])')!;
      this.#titleEl = shadow.querySelector<HTMLElement>('.player-title')!;
      this.#channelEl = shadow.querySelector<HTMLElement>('.player-channel')!;

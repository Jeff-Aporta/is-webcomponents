 ...
 * iconos propio (`assets/icons/`, publicado en `dist/assets/icons/`) y se
...
(() => {
  ...
  class IsIcon extends HTMLElement {
    ...
    constructor() {
      ...
      this.#inline = shadow.querySelector<HTMLElement>('.inline')!;
    }
     ...
     */
    #normalizeInlineSvg() {
      const svg = this.#inline.querySelector<HTMLElement>('svg');
      if (!svg) return;

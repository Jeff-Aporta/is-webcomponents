...
export async function mount(ctx) {
  ...
  // ── Demo disabled ─────────────────────────────────────────────────────────
  const ro2 = root.querySelector('#ro2');
  const roBox2 = root.querySelector('#roBox2');
  const roSize2 = root.querySelector('#roSize2');
  const roLog2 = root.querySelector('#roLog2');
  const roToggle = root.querySelector('#roToggle');
  const ro2Status = root.querySelector('#ro2Status');

...
export function needsGlobalSnippetCss(classes: Set<string>) {
...
export function needsPreviewSnippetCss(html: string, previewStyles: string) {
 ...
 */
export function buildDemoSnippetStyles(html: string, previewStyles: string = '') {
  const parts = [];

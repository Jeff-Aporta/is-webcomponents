...
const prefsPath = join(root, 'components', '_shared', 'prefs.js');
const agGridPath = join(root, 'components', 'data', 'ag-grid.js');
const agGridMdPath = join(root, 'components', 'data', 'ag-grid.md');
const mainPath = join(root, 'components', 'layout', 'main.js');
const splitPath = join(root, 'components', 'layout', 'split-panel.js');
const dataLlm = join(root, 'components', 'data', 'LLM.md');
...
const inventory = readFileSync(join(root, 'components', 'LLM.md'), 'utf8');
check(
...
const docsToScan = [
  join(root, 'components', 'data', 'LLM.md'),
  join(root, 'components', 'layout', 'LLM.md'),
  join(root, 'components', 'data', 'ag-grid.md'),
  join(root, 'previews', 'data', 'is-ag-grid.html'),
].filter(existsSync);

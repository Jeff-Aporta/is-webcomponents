...
test('4. OBSERVED incluye src, poster, muted, loop, autoplay, playsinline', () => {
...
test('5. expone métodos play(), pause(), toggleFullscreen(), togglePictureInPicture()', () => {
  const src = readFileSync(TS, 'utf8');
...
test('6. emite is-play, is-pause, is-ended', () => {
  const src = readFileSync(TS, 'utf8');
...
test('7. reenvía eventos nativos del elemento <video>', () => {
  const src = readFileSync(TS, 'utf8');

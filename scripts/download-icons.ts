...
// Los iconos se descargan directamente sobre lo publicado: `dist/assets/`
// es la unica copia del material. Antes se bajaban a `src/assets/icons/` y el
// build los copiaba a dist, con lo que el mismo set vivia dos veces en disco.
// `dist/assets/` no se borra al regenerar dist/cdn/.

 ...
 *   node path/to/download-iconify.mjs --projectRoot=. --outputDir=src/assets/icons
 *   node scripts/download-iconify.mjs --projectRoot=../mi-app --outputDir=src/assets/icons
 *
...
const OWN_CDN_BASES = [
  'https://jeff-aporta.github.io/is-webcomponents/dist/cdn/src/assets/icons/',
  'https://cdn.jsdelivr.net/gh/Jeff-Aporta/is-webcomponents@main/dist/cdn/src/assets/icons/',
];
...
if (isMain) {
  ...
  const outputDir = args.outputDir || 'src/assets/icons';

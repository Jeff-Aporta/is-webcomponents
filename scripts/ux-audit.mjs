/**
 * ux-audit.mjs — QA UX de la galería: carga cada preview, interactúa demos,
 * captura pantallazos y recolecta errores de consola / pageerror.
 *
 * Uso:
 *   node scripts/serve.mjs 8391          # en otra terminal
 *   node scripts/ux-audit.mjs            # barrido completo
 *   node scripts/ux-audit.mjs --only is-button,is-toast
 *   node scripts/ux-audit.mjs --limit 10
 *   node scripts/ux-audit.mjs --port 8391 --out .tmp/ux-audit
 *
...
const manifest = (await import(pathToFileURL(join(root, 'manifest.js')).href)).default;

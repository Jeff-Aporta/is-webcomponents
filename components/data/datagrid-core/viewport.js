 ...
 * @returns {RowWindow}
 */
export function rowWindow(rowCount, rowHeight, scrollTop, viewportHeight, overscan = 6) {
 ...
 *
 * @param {import('./types.js').ColumnState[]} center
 * @param {import('./types.js').ColumnState[]} left
 * @param {import('./types.js').ColumnState[]} right
 * @returns {ColLayout}
 */
export function columnLayout(center, left, right) {
  const positions = [];
  let x = 0;
 ...
 */
export function colWindow(layout, scrollLeft, viewportWidth, overscan = 2) {
 ...
 */
export function applyFlex(cols, availableWidth) {

...
// los demos de la categoría `helpers`. Réplica casi exacta del harness de
// demos/diagramas/ER para que los tests sean consistentes.
//
...
// tests corren con `cwd: repoRoot`, así que process.cwd() == repo root.
// REPO_ROOT se mantiene exportado por compatibilidad con tests previos.

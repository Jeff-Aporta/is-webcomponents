...
**Architecture:** Un MD vive junto a cada pareja JS/CSS; módulos multi-tag comparten MD. Diez `LLM.md` de categoría y `components/LLM.md` guían navegación, reutilización, reglas y errores. Checker Node deriva inventario desde `manifest.js`, evitando conteos manuales como única defensa.
...
- Crear 10 índices de categoría + `components/LLM.md`; 115 MD bajo `components/`.
...
- `components/actions/button.md`, `components/actions/button-group.md`, `components/actions/copy-button.md`, `components/actions/check-icon-button.md`, `components/actions/dropdown.md`, `components/actions/dropdown-item.md`, `components/actions/fab.md`.
- `components/charts/chart.md`, `components/charts/bar-chart.md`, `components/charts/line-chart.md`, `components/charts/pie-chart.md`, `components/charts/doughnut-chart.md`, `components/charts/radar-chart.md`, `components/charts/polar-area-chart.md`, `components/charts/scatter-chart.md`, `components/charts/bubble-chart.md`, `components/charts/sparkline.md`, `components/charts/waterfall-chart.md`, `components/charts/funnel-chart.md`, `components/charts/treemap.md`.
- `components/data/data-grid.md`, `components/data/stat.md`, `components/data/transfer.md`, `components/data/gauge.md`, `components/data/kanban.md`.
- `components/diagrams/flowchart.md`, `components/diagrams/sequence-diagram.md`, `components/diagrams/lightbox.md`, `components/diagrams/diagram-lightbox.md`, `components/diagrams/class-diagram.md`, `components/diagrams/state-diagram.md`, `components/diagrams/er-diagram.md`, `components/diagrams/block-diagram.md`, `components/diagrams/mindmap.md`, `components/diagrams/gantt.md`, `components/diagrams/timeline.md`.
- `components/feedback/spinner.md`, `components/feedback/badge.md`, `components/feedback/tag.md`, `components/feedback/skeleton.md`, `components/feedback/progress-bar.md`, `components/feedback/progress-ring.md`, `components/feedback/theme-toggle.md`, `components/feedback/toast.md`, `components/feedback/toast-item.md`, `components/feedback/tooltip.md`, `components/feedback/cdn-snippet.md`, `components/feedback/popconfirm.md`.
- `components/forms/combobox.md`, `components/forms/option.md`, `components/forms/checkbox.md`, `components/forms/switch.md`, `components/forms/radio-group.md`, `components/forms/radio.md`, `components/forms/input.md`, `components/forms/textarea.md`, `components/forms/slider.md`, `components/forms/rating.md`, `components/forms/select.md`, `components/forms/color-picker.md`, `components/forms/file-input.md`, `components/forms/date-picker.md`, `components/forms/month-calendar.md`, `components/forms/year-calendar.md`, `components/forms/date-range-picker.md`, `components/forms/time-clock.md`, `components/forms/digital-clock.md`, `components/forms/date-field.md`, `components/forms/time-field.md`, `components/forms/date-time-field.md`, `components/forms/date-input.md`, `components/forms/time-input.md`, `components/forms/date-time-input.md`, `components/forms/date-range-input.md`, `components/forms/pin-input.md`.
- `components/helpers/popover.md`, `components/helpers/relative-time.md`, `components/helpers/format-date.md`, `components/helpers/format-number.md`, `components/helpers/format-bytes.md`, `components/helpers/intersection-observer.md`, `components/helpers/mutation-observer.md`, `components/helpers/resize-observer.md`, `components/helpers/popup.md`.
- `components/layout/split-panel.md`, `components/layout/main.md`, `components/layout/card.md`, `components/layout/callout.md`, `components/layout/details.md`, `components/layout/dialog.md`, `components/layout/drawer.md`, `components/layout/divider.md`, `components/layout/scrollspy.md`.
- `components/media/icon.md`, `components/media/avatar.md`, `components/media/video.md`, `components/media/video-playlist.md`.
- `components/navigation/breadcrumb.md`, `components/navigation/breadcrumb-item.md`, `components/navigation/tab-group.md`, `components/navigation/scroller.md`, `components/navigation/carousel.md`, `components/navigation/tree.md`, `components/navigation/stepper.md`.
- Índices: `components/actions/LLM.md`, `components/charts/LLM.md`, `components/data/LLM.md`, `components/diagrams/LLM.md`, `components/feedback/LLM.md`, `components/forms/LLM.md`, `components/helpers/LLM.md`, `components/layout/LLM.md`, `components/media/LLM.md`, `components/navigation/LLM.md`, `components/LLM.md`.
...
**Interfaces:**
- Consumes: default export de `manifest.js`, árbol `components/`, previews.
...
**Files:**
- Create: `components/actions/{button,button-group,copy-button,check-icon-button,dropdown,dropdown-item,fab}.md`
- Create: `components/actions/LLM.md`
...
- [ ] Verificar archivos: `node --input-type=module -e "import fs from 'node:fs'; for (const n of 'button button-group copy-button check-icon-button dropdown dropdown-item fab LLM'.split(' ')) if (!fs.existsSync('components/actions/'+n+'.md')) throw Error(n); console.log('PASS actions')"`
...
**Files:**
- Create: `components/charts/{chart,bar-chart,line-chart,pie-chart,doughnut-chart,radar-chart,polar-area-chart,scatter-chart,bubble-chart,sparkline,waterfall-chart,funnel-chart,treemap}.md`
- Create: `components/charts/LLM.md`
...
**Files:**
- Create: `components/data/{data-grid,stat,transfer,gauge,kanban}.md`
- Create: `components/data/LLM.md`
...
- [ ] Verificar: `node --input-type=module -e "import fs from 'node:fs'; for (const n of 'data-grid stat transfer gauge kanban LLM'.split(' ')) if (!fs.existsSync('components/data/'+n+'.md')) throw Error(n); console.log('PASS data')"`
...
**Files:**
- Create: `components/diagrams/{flowchart,sequence-diagram,lightbox,diagram-lightbox,class-diagram,state-diagram,er-diagram,block-diagram,mindmap,gantt,timeline}.md`
- Create: `components/diagrams/LLM.md`
...
- [ ] Verificar: `node --input-type=module -e "import fs from 'node:fs'; for (const n of 'flowchart sequence-diagram lightbox diagram-lightbox class-diagram state-diagram er-diagram block-diagram mindmap gantt timeline LLM'.split(' ')) if (!fs.existsSync('components/diagrams/'+n+'.md')) throw Error(n); console.log('PASS diagrams')"`
...
**Files:**
- Create: `components/feedback/{spinner,badge,tag,skeleton,progress-bar,progress-ring,theme-toggle,toast,toast-item,tooltip,cdn-snippet,popconfirm}.md`
- Create: `components/feedback/LLM.md`
...
- [ ] Verificar: `node --input-type=module -e "import fs from 'node:fs'; for (const n of 'spinner badge tag skeleton progress-bar progress-ring theme-toggle toast toast-item tooltip cdn-snippet popconfirm LLM'.split(' ')) if (!fs.existsSync('components/feedback/'+n+'.md')) throw Error(n); console.log('PASS feedback')"`
...
- [ ] Verificar: `node --input-type=module -e "import fs from 'node:fs'; for (const n of 'combobox option checkbox switch radio-group radio input textarea slider rating select color-picker file-input date-picker month-calendar year-calendar date-range-picker time-clock digital-clock date-field time-field date-time-field date-input time-input date-time-input date-range-input pin-input LLM'.split(' ')) if (!fs.existsSync('components/forms/'+n+'.md')) throw Error(n); console.log('PASS forms')"`
...
**Files:**
- Create: `components/helpers/{popover,relative-time,format-date,format-number,format-bytes,intersection-observer,mutation-observer,resize-observer,popup}.md`
- Create: `components/helpers/LLM.md`
...
- [ ] Verificar: `node --input-type=module -e "import fs from 'node:fs'; for (const n of 'popover relative-time format-date format-number format-bytes intersection-observer mutation-observer resize-observer popup LLM'.split(' ')) if (!fs.existsSync('components/helpers/'+n+'.md')) throw Error(n); console.log('PASS helpers')"`
...
**Files:**
- Create: `components/layout/{split-panel,main,card,callout,details,dialog,drawer,divider,scrollspy}.md`
- Create: `components/layout/LLM.md`
...
- [ ] Verificar: `node --input-type=module -e "import fs from 'node:fs'; for (const n of 'split-panel main card callout details dialog drawer divider scrollspy LLM'.split(' ')) if (!fs.existsSync('components/layout/'+n+'.md')) throw Error(n); console.log('PASS layout')"`
...
**Files:**
- Create: `components/media/{icon,avatar,video,video-playlist}.md`
- Create: `components/media/LLM.md`
...
- [ ] Verificar: `node --input-type=module -e "import fs from 'node:fs'; for (const n of 'icon avatar video video-playlist LLM'.split(' ')) if (!fs.existsSync('components/media/'+n+'.md')) throw Error(n); console.log('PASS media')"`
...
**Files:**
- Create: `components/navigation/{breadcrumb,breadcrumb-item,tab-group,scroller,carousel,tree,stepper}.md`
- Create: `components/navigation/LLM.md`
...
- [ ] Verificar: `node --input-type=module -e "import fs from 'node:fs'; for (const n of 'breadcrumb breadcrumb-item tab-group scroller carousel tree stepper LLM'.split(' ')) if (!fs.existsSync('components/navigation/'+n+'.md')) throw Error(n); console.log('PASS navigation')"`
...
**Files:**
- Create: `components/LLM.md`
- Verify: `components/**/*.md`

...
## Testables del grupo (categoría: layout)

### Demos a auditar (2)
  - src/components/layout/dock.preview.ts (behavior)
  - src/components/layout/main.preview.ts (behavior)

### JSON de cada demo (estructura + secciones)
  - src/components/layout/dock.json (estructura)
  - src/components/layout/main.json (estructura)
...
## Output
Sobrescribe el archivo `.audit/proposals/demo-g11.md` con la salida completa en markdown.

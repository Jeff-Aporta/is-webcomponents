...
## Testables del grupo (categoría: helpers)

### Demos a auditar (6)
  - src/components/helpers/format-date.preview.ts (behavior)
  - src/components/helpers/mutation-observer.preview.ts (behavior)
  - src/components/helpers/observer.preview.ts (behavior)
  - src/components/helpers/relative-time.preview.ts (behavior)
  - src/components/helpers/resize-observer.preview.ts (behavior)
  - src/components/helpers/ui.preview.ts (behavior)

### JSON de cada demo (estructura + secciones)
  - src/components/helpers/format-date.json (estructura)
  - src/components/helpers/mutation-observer.json (estructura)
  - src/components/helpers/observer.json (estructura)
  - src/components/helpers/relative-time.json (estructura)
  - src/components/helpers/resize-observer.json (estructura)
  - src/components/helpers/ui.json (estructura)
...
## Output
Sobrescribe el archivo `.audit/proposals/demo-g09.md` con la salida completa en markdown.

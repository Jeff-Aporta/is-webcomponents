# F0.3 propuesta UX/UI exhaustiva — diagrams (4 demos: diagram-lightbox, lightbox, org-chart, sequence-diagram)
...
## Testables del grupo (categoría: diagrams)

### Demos a auditar (4)
  - src/components/diagrams/diagram-lightbox.preview.ts (behavior)
  - src/components/diagrams/lightbox.preview.ts (behavior)
  - src/components/diagrams/org-chart.preview.ts (behavior)
  - src/components/diagrams/sequence-diagram.preview.ts (behavior)

### JSON de cada demo (estructura + secciones)
  - src/components/diagrams/diagram-lightbox.json (estructura)
  - src/components/diagrams/lightbox.json (estructura)
  - src/components/diagrams/org-chart.json (estructura)
  - src/components/diagrams/sequence-diagram.json (estructura)
...
## Output
Sobrescribe el archivo `.audit/proposals/demo-g06.md` con la salida completa en markdown.

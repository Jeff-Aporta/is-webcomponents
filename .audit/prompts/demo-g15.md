# F0.3 propuesta UX/UI exhaustiva — pages + gallery (3 pages + gallery SPA: ecosystem, home, theming)
...
## Testables del grupo (categoría: pages-gallery)

### Demos a auditar (3)
  - src/components/pages-gallery/ecosystem.preview.ts (behavior)
  - src/components/pages-gallery/home.preview.ts (behavior)
  - src/components/pages-gallery/theming.preview.ts (behavior)

### JSON de cada demo (estructura + secciones)
  - src/components/pages-gallery/ecosystem.json (estructura)
  - src/components/pages-gallery/home.json (estructura)
  - src/components/pages-gallery/theming.json (estructura)
...
## Output
Sobrescribe el archivo `.audit/proposals/demo-g15.md` con la salida completa en markdown.

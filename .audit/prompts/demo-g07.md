# F0.3 propuesta UX/UI exhaustiva — feedback (3 demos: progress-bar, toast, tooltip)
...
## Testables del grupo (categoría: feedback)

### Demos a auditar (3)
  - src/components/feedback/progress-bar.preview.ts (behavior)
  - src/components/feedback/toast.preview.ts (behavior)
  - src/components/feedback/tooltip.preview.ts (behavior)

### JSON de cada demo (estructura + secciones)
  - src/components/feedback/progress-bar.json (estructura)
  - src/components/feedback/toast.json (estructura)
  - src/components/feedback/tooltip.json (estructura)
...
## Output
Sobrescribe el archivo `.audit/proposals/demo-g07.md` con la salida completa en markdown.

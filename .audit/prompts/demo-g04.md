...
## Testables del grupo (categoría: data)

### Demos a auditar (4)
  - src/components/data/ag-grid.preview.ts (behavior)
  - src/components/data/data-grid.preview.ts (behavior)
  - src/components/data/gauge.preview.ts (behavior)
  - src/components/data/pivot-table.preview.ts (behavior)

### JSON de cada demo (estructura + secciones)
  - src/components/data/ag-grid.json (estructura)
  - src/components/data/data-grid.json (estructura)
  - src/components/data/gauge.json (estructura)
  - src/components/data/pivot-table.json (estructura)
...
## Output
Sobrescribe el archivo `.audit/proposals/demo-g04.md` con la salida completa en markdown.

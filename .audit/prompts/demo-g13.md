# F0.3 propuesta UX/UI exhaustiva — navigation (1 demos: mega-menu)
...
## Testables del grupo (categoría: navigation)

### Demos a auditar (1)
  - src/components/navigation/mega-menu.preview.ts (behavior)

### JSON de cada demo (estructura + secciones)
  - src/components/navigation/mega-menu.json (estructura)
...
## Output
Sobrescribe el archivo `.audit/proposals/demo-g13.md` con la salida completa en markdown.
